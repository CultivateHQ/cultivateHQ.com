...
2. In order to get data in and out of Elm we use a mechanism called <a href="http://elm-lang.org/guide/interop#ports">ports</a>. Add the following port to a signals section at the bottom of the file.
